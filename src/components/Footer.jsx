                    ...
                    <Grid container spacing={2}>
                        ...
                        <Grid item xs={12} lg={6}>
                            <Stack spacing={2} direction={{ sx: "column", lg: "row" }} color={"primary.main"}>
                                ...
                                <Button color='inherit' startIcon={<PolicyRounded />} LinkComponent={Link} variant="text" to="/">Privacy Policy</Button>
                                <Button color='inherit' startIcon={<PolicyRounded />} LinkComponent={Link} variant="text" to="/">Terms & Conditions</Button>
